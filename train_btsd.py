...
def train(net,data):
        ...
        output_dir = os.path.join('saves', 'BTSD2018_03_10_18_28')
        # output_dir = os.path.join(
        #     'saves', 'BTSD'+datetime.datetime.now().strftime('%Y_%m_%d_%H_%M'))
        ...
        print 'restoring session from : ', ckpt_file+'-1751'
        restorer.restore(sess,ckpt_file+'-1751')
